...
from VDP_Layers import VDP_Flatten, VDP_Conv2D, VDP_Relu, VDP_Maxpool, VDP_FullyConnected, VDP_Softmax
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.fullyCon1 = VDP_FullyConnected(784, 1200, input_flag=True, weight_args=self.fc_init)
        self.relu = VDP_Relu()
        self.fullyCon2 = VDP_FullyConnected(1200, 10, weight_args=self.fc_init)
