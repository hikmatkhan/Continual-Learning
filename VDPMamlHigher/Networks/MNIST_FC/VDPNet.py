...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.fullyCon1 = VDP_FullyConnected(784, 1024, input_flag=True, weight_args=self.fc_init)
        # self.fullyCon1 = VDP_FullyConnected(784, 512, input_flag=True, weight_args=self.fc_init)
        self.relu = VDP_Relu()
        # Added
        self.fullyCon3 = VDP_FullyConnected(1024, 512, weight_args=self.fc_init)
        # self.fullyCon4 = VDP_FullyConnected(512, 256, weight_args=self.fc_init)
        # self.dropout = nn.Dropout(0.25)

        self.fullyCon2 = VDP_FullyConnected(512, args.ways, weight_args=self.fc_init)
