        ...
        **kwargs
        ...
        Args:
            ...
            track_higher_grads: if True, during unrolled optimization the graph
                ...
                "test mode", without potentially tracking highers order
...
class DifferentiableRprop(DifferentiableOptimizer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        _warnings.warn(
            ...
            "Future versions will offer highers order gradients based on a "
...
def get_diff_optim(
    ...
    **kwargs
    ...
    Args:
        opt: an existing optimizer, assumed to be an instance of
            ...
            highers at runtime by using ``highers.register_optim``. We assume this
        ...
        track_higher_grads: if True, during unrolled optimization the graph be
            ...
            "test mode", without potentially tracking highers order gradients.
  ...
  """
    if type(opt) in _opt_mapping:
        ...
        raise ValueError(
            "Optimizer type {} not supported by highers yet.".format(type(opt))
        )
...
def create_diff_optim(
  ...
  """
    ...
    if opt_type in _opt_mapping:
        ...
        raise ValueError(
            "Optimizer type {} not supported by highers yet.".format(opt_type)
        )
...
def register_optim(
    ...
    r"""Registers a new optimizer type for use with highers functions.
    ...
    Args:
        ...
        diff_optim_type: the type of a new differentiable optimizer, assumed to
            be an instance of ``highers.optim.DifferentiableOptimizer`` with
