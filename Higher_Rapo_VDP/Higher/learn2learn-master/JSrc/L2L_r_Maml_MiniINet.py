...
viz.add_argument('--wand-project', type=str, default="l2l_mini_imagenet",
...
viz.add_argument('--vdp', type=str, default="V2+Maml+L2L+CNN+MiniImageNet",
...
def main(args):
    ...
    # import lenet
    # model = lenet.Get_Yann_LeNet(out_dim=args.ways)
    model.to(args.device)
    print("MAML:", model)
    ...
    for iteration in range(args.epochs):
        ...
        if best_meta_valid_accuracy < meta_valid_accuracy and meta_valid_accuracy > 0.3:
            ...
            jutils.save_best_model(model=maml.module,
                                   ...
                                   root_folder="maml_mini_imagenet")
