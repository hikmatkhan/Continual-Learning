...
class Net(nn.Module):
    ...
    # self.linear1 = nn.Linear(120, 84)
        ...
        self.conv2d1 = VDP_Conv2D(3, 6, 5, input_flag=True)
        self.conv2d2 = VDP_Conv2D(6, 16, 5)
        self.conv2d3 = VDP_Conv2D(16, 120, 3)
        ...
        self.fullyCon1 = VDP_FullyConnected(1080, 84)
        self.fullyCon2 = VDP_FullyConnected(84, args.ways)
    ...
    def forward(self, x_input):
        ...
        mu, sigma = self.fullyCon2(mu, sigma)
