...
os.environ["CUDA_VISIBLE_DEVICES"] = "7" # GPU
...
viz.add_argument('--wand-project', type=str, default="l2l_omniglot",
...
def main(args):
    ...
    model = l2l.vision.models.MiniImagenetCNN(args.ways).to(args.device)
