...
# wandb: Created sweep with ID: o0m3novx
# wandb: View sweep at: https://wandb.ai/hikmatkhan-/uncategorized/sweeps/o0m3novx
# wandb: Run sweep agent with: wandb agent hikmatkhan-/uncategorized/o0m3novx
...
misc.add_argument('--device', type=str, default=utils.get_compute_device(),
...
if __name__ == '__main__':
    args.device = utils.get_compute_device()
    print(args)
